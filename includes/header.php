...
<head>
	...
	<title>Gestion de Stock de Magasin</title>
      ...
      <ul class="nav navbar-nav navbar-right">        
        ...
        <li class="dropdown" id="navOrder">
          ...
          <ul class="dropdown-menu">            
            <li id="topNavAddOrder"><a href="orders.php?o=add"> <i class="glyphicon glyphicon-plus"></i> Ajouter Commande </a></li>            
            <li id="topNavManageOrder"><a href="orders.php?o=manord"> <i class="glyphicon glyphicon-edit"></i> Gérer Commande</a></li>            
          </ul>
        </li>   
